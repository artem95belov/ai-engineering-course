"""
Модуль 2, Задание 5 — промпт-дизайн для классификации обращений.
...
Обращение: "Как часто делать ТО компрессора по регламенту?" -> регламент
Обращение: "Нужен паспорт на насос Р-481" -> документация
Обращение: "В какой срок нужно оформить карточку инцидента после остановки?" -> регламент
Обращение: "Где найти свежую версию по платформе" -> документация
"""
