"""
Модуль 3, Занятие 6, практика 1 — локальное векторное хранилище.

В Занятии 5 мы считали близость двух фраз вручную. Так можно сравнить 2 текста,
...
# в задании. На место ___ впиши минимум 2 своих запроса.
QUERIES = [
    ...
    # два своих запроса: настоящий и каверзный
...
def show(hits, query: str):
    ...
    for h in hits:
        ...
        print(f"    {h.score:5.3f}  [{h.payload['type']:<21}] {h.payload['title']}{flag}")
